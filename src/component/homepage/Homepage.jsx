...
//                 {/* Badge/Tagline */}
//                 <div className="inline-block mt-2 sm:mt-4 bg-white/10 backdrop-blur-lg border border-white/20 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl font-bold text-xs sm:text-sm tracking-wider shadow-2xl">
//                   PREMIUM PROPERTY SOLUTIONS
//                 </div>

//                 {/* Main Heading */}
//                 <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-[78px] font-black leading-tight sm:leading-none tracking-tight">
...
//                   Join Malaysia's fastest-growing hospitality brand, proudly founded by Aima and
//                   Hezreen.
//                 </p>
//               </div>
...
//                   {/* <button className="w-full bg-black text-white py-3 rounded-xl font-bold hover:bg-gray-800 transition-colors duration-300">
//                     View Details
//                   </button> */}
//                 </div>
//               </div>
